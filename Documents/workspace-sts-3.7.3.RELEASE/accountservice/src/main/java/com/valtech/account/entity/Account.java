...
public class Account {
	...
	public Account(long id, String accountType, double balance, LocalDateTime creationDate,
			LocalDateTime lastUpdateDate, boolean active, Set<Customer> customers) {
		super();
		this.id = id;
	...
	public Account(String accountType, double balance, LocalDateTime creationDate, LocalDateTime lastUpdateDate,
			boolean active) {
		super();
		this.accountType = accountType;
		this.balance = balance;
