...
public class IOExample {
	...
	public String readFromFile(String fileName) throws Exception{
		...
		// 16k or 32k buffer size is ideal
		File file = new File(fileName);
	...
	public static void main(String[] args) throws Exception {
		...
		ex.writeToFile("hello.text","Hello World");
		System.out.println(ex.readFromFile("hello.text"));
		ex.writeCharsToFile("hello.text","How are you ?");
		System.out.println(ex.readCharsFromFile("hello.text"));			
	}
}
